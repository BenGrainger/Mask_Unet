...
from mask_unet.training.train_segmentor import train_segmentor
...
train_dir = "/ceph/zoo/users/debris/Mask_training_script_Unet/debris_data/train/"
val_dir = "/ceph/zoo/users/debris/Mask_training_script_Unet/debris_data/val/"
...
train_segmentor(model, optimizer, train_loader, val_loader, criterion, DEVICE, num_epochs, model_save_path)
