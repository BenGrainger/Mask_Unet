...
from torchdataset import SegmentationDatasetMulti
import segmentation_models_pytorch as smp 
import torchmetrics

## Dataset and Dataloader
test_ds = SegmentationDatasetMulti(path_name='sample_data/test')
...
## load weights
model.load_state_dict(torch.load('models/unet_multiclass_segmentation.pth'))
